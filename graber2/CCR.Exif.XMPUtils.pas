...
uses
  Types, SysUtils, Classes, xmldom, CCR.Exif.BaseUtils, CCR.Exif.TiffUtils, TimeSpan;
...
type
  ...
  public
    ...
    procedure SaveToGraphic(const Stream: TStream); overload;
...
procedure TXMPPacket.SaveToGraphic(const Stream: TStream);
begin
