...
I didn't do any hardcoding updates in a very long time. All one needs to update/make it's own script is in "resources" folder. It isn't hard to understand if you aren't new to scripting languages (all though it's a selfmade script syntax).
