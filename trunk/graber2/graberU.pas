          ...
          begin
            ...
            try
              ...
              try
                ...
                if (FHTTP.ResponseCode = 302)
                // or (FHTTP.ResponseCode = 404)
                then
                else
                  raise;
              end;
...
begin
  ...
  begin
    try
      ...
      if FPicsAdded { Assigned(FLPicList) and (FPicList.Count > 0) } then
      begin
        // CSData.Enter;
        // try
        // FLPicList.AddPicList(FPicList, FPicture);
